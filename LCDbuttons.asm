...
isr_vec:
	  ...
	  banksel INTCON
          ...
          banksel PORTB
          ; si bit ÃÂ  0 on incrÃÂ©mente le compteur debounce_counter, sinon on remet ÃÂ  0 le compteur
...
start:
        ...
        ; vÃÂ©rifier sans ce banksel, ÃÂ§a devrait marcher normalement car INTCON
...
if_button_inc:     BTFSC button_status, 0       ; si le boutton est appuyÃ© fait insrt suivante
...
then_button_inc:
		    MOVLW   0xCA
                    ...
                    CALL    move_cursor
		    INCF    one           ;incrÃ©mente le digit courant
                    MOVLW   0x30
                    ADDWF   one,0
                    MOVWF   PORTC
                    CALL    Enable
